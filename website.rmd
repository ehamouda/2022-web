...
* Click _Settings_ in the top right of the navigation bar in your repository. 
    ...
    - Under _Source_, select _main_. (_Note: [Chapter 3.3 of the bookdown manual](https://bookdown.org/yihui/blogdown/github-pages.html) has instructions for publishing something other than the top level folder for a repo, such as a `public` folder_)
